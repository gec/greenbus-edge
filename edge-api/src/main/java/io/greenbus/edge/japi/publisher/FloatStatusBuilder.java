...
public class FloatStatusBuilder extends AbstractAnalogBuilder<FloatStatusBuilder, FloatSeriesHandle> {

    public FloatStatusBuilder(EndpointBuilder builder, Path path) {
