...
public class AnalogSetpointBuilder {
    ...
    public AnalogSetpointBuilder(EndpointBuilder builder, Path path) {
        this.builder = builder;
        this.path = path;
    }

    public AnalogSetpointBuilder setScale(double scale) {
        this.scale = scale;
        return this;
    }
    public AnalogSetpointBuilder setOffset(double offset) {
        this.offset = offset;
        return this;
    }

    public AnalogSetpointBuilder addMetadata(Path path, Value value) {
        metadata.put(path, value);
        return this;
    }
    public AnalogSetpointBuilder addMetadata(Map<Path, Value> metadata) {
        this.metadata.putAll(metadata);
        return this;
    }

    public OutputEntry build() {
        metadata.put(JavaCoreModel.outputTypeKey(), JavaCoreModel.outputTypeValue(OutputType.AnalogSetpoint));

        if (scale != null) {
            metadata.put(JavaCoreModel.requestScaleKey(), JavaCoreModel.requestScaleValue(scale));
        }
        if (offset != null) {
            metadata.put(JavaCoreModel.requestOffsetKey(), JavaCoreModel.requestOffsetValue(offset));
        }
