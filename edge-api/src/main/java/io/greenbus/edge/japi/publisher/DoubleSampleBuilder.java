...
public class DoubleSampleBuilder extends AbstractAnalogBuilder<DoubleSampleBuilder, DoubleSeriesHandle> {

    public DoubleSampleBuilder(EndpointBuilder builder, Path path) {
