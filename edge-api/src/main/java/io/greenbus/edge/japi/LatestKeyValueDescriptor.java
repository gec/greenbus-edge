...
public class LatestKeyValueDescriptor implements DataKeyDescriptor {
    private final Map<Path, Value> metadata;

    public LatestKeyValueDescriptor(Map<Path, Value> metadata) {
    ...
    public boolean equals(Object o) {
        ...
        LatestKeyValueDescriptor that = (LatestKeyValueDescriptor) o;
