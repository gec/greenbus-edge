...
public class SimpleIndicationBuilder {
    private final EndpointBuilder builder;
    private final Path path;
    private final Map<Path, Value> metadata = new HashMap<>();

    public SimpleIndicationBuilder(EndpointBuilder builder, Path path) {
        this.builder = builder;
        this.path = path;
    }

    public SimpleIndicationBuilder addMetadata(Path path, Value value) {
        metadata.put(path, value);
        return this;
    }
    public SimpleIndicationBuilder addMetadata(Map<Path, Value> metadata) {
