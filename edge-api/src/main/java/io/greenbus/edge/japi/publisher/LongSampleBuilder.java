...
public class LongSampleBuilder extends AbstractAnalogBuilder<LongSampleBuilder, LongSeriesHandle> {
    public LongSampleBuilder(EndpointBuilder builder, Path path) {
