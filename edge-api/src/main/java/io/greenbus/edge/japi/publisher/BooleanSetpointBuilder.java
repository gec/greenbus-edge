...
public class BooleanSetpointBuilder {
    ...
    public BooleanSetpointBuilder(EndpointBuilder builder, Path path) {
        this.builder = builder;
        this.path = path;
    }

    public BooleanSetpointBuilder setLabels(String truthLabel, String falseLabel) {
        this.truthLabel = truthLabel;
        this.falseLabel = falseLabel;
        return this;
    }
    public BooleanSetpointBuilder addMetadata(Path path, Value value) {
        metadata.put(path, value);
        return this;
    }
    public BooleanSetpointBuilder addMetadata(Map<Path, Value> metadata) {
        this.metadata.putAll(metadata);
        return this;
    }

    public OutputEntry build() {
        metadata.put(JavaCoreModel.outputTypeKey(), JavaCoreModel.outputTypeValue(OutputType.BooleanSetpoint));

        if (truthLabel != null && falseLabel != null) {
            metadata.put(JavaCoreModel.requestBooleanLabelsKey(), JavaCoreModel.requestBooleanLabelsValue(truthLabel, falseLabel));
        }
