...
public class IntStatusBuilder extends AbstractAnalogBuilder<IntStatusBuilder, IntSeriesHandle> {
    public IntStatusBuilder(EndpointBuilder builder, Path path) {
        super(builder, path, SeriesType.AnalogStatus);
    }

    @Override
    protected IntSeriesHandle buildHandle(SeriesValueHandle impl) {
        return new IntSeriesWrapper(impl);
    }
}
