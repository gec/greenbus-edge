...
public class OutputKeyDescriptor implements KeyDescriptor {
    private final Map<Path, Value> metadata;

    public OutputKeyDescriptor(Map<Path, Value> metadata) {
    ...
    public boolean equals(Object o) {
        ...
        OutputKeyDescriptor that = (OutputKeyDescriptor) o;
