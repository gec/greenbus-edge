...
public class DoubleStatusBuilder extends AbstractAnalogBuilder<DoubleStatusBuilder, DoubleSeriesHandle> {
    public DoubleStatusBuilder(EndpointBuilder builder, Path path) {
        super(builder, path, SeriesType.AnalogStatus);
    }

    @Override
    protected DoubleSeriesHandle buildHandle(SeriesValueHandle impl) {
        return new DoubleSeriesWrapper(impl);
    }
}
